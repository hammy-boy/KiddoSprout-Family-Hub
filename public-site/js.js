    ...
    function openApp(app, trigger = null) {
      if (isDemoMode() && (app === "spending" || app === "recipe")) {
        showToast("Connected apps are unavailable in Demo Mode.");
        return;
      }
      const child = currentChild();
      if (!child) {
      ...
      if (app === "recipe") {
        return `
          <div class="mini-card recipe-card">
            ...
            <a class="mini-link" href="recipe.html" data-demo-protected="Connected recipes are off">Open Recipe Page</a>
          </div>
